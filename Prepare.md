...
Даты, категории и прочие метаданные в именах папок я не использую. В большинстве случаев они не добавляют понятности, а лишь усложняют и удлиняют имя. Если у вас много похожих съёмок и сложно кадждый раз выдумывать новые имена, то дата — простой способ сделать имя уникальным. Но фанатизм тут не нужен: просто добавьте дату в произвольном формате в скобках.
