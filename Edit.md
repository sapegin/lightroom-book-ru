...
Распылитель (Painter) — интересный инструмент, которым мало кто пользуется. Он позволяет одним кликом применить к фотографии одно заранее выбранное свойство. Свойств на выбор довольно много: звёздочки, цветные метки, флаги, пресеты метаданных, пресеты ключевых слов, пресеты проявки и добавление в коллекции.
