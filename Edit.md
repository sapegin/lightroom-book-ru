...
Нажмите E или Enter (View — Loupe) и выделенная фотография будет показана во весь экран. Стрелками на клавиатуре (← и →) можно перемещаться вперёд или назад.
...
Панель фильтра включается клавишей \ (View — Show Filter Bar). Однако, видимость панели никак не влияет на активность фильтра: если в шапке панели подсвечены слова Text, Attribute или Metadata — фильтр включён, если None — выключен.
...
* Лайтрум всегда ищет только внутри текущей папки или коллекции. Чтобы искать сразу по всему каталогу, выберите All Photographs в верхней части левой панели:
...
* Если после импорта вы видите пустой экран, значит у вас остался включённым фильтр с прошлой съёмки. Снимите чекбокс Library — Enable Filter (Cmd+L) или нажмите None на панели фильтра, и вы увидите свои фотографии.
...
* Управлять фильтром можно не только на панели фильтров, но и на нижней панели миниатюр (список в правой части заголовка), и через меню: Library — Filter by Preset (Filter by Flag, Filter by Rating и так далее).
...
Можно выделить сразу много много фотографий: сравниваться по-прежнему будут только две, но при снятии флага с худшей из двух, на её месте будет появляться следующая, пока не останется только одна, лучшая, фотография.
...
Чтобы не вводить одни и те же ключевые слова несколько раз, можно выделить несколько фотографий, и добавить ключевые слова сразу всем. Или можно выбрать Recent Keywords в списке Keyword Set: появится панель с девятью последними ключевыми словами. Или использовать распылитель (см. выше).
...
Когда я заканчиваю отбор фотографий, то нажимаю Cmd+Backspace (Photo — Delete Rejected Photos), а затем Delete From Disk. И Лайтрум удаляет с диска все фотографии с чёрным флагом.
